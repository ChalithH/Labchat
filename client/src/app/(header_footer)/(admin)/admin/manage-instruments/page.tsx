...
import ManageInstrumentsClient from "../../components/clients/ManageInstrumentsClient"
import { redirect } from "next/navigation"
import { cookies } from 'next/headers'
import setUsersLastViewed from "@/lib/set_last_viewed"
import ResolveRoleName from '@/lib/resolve_role_name.util'

const ManageInstruments: React.FC = async () => {
    setUsersLastViewed(`/admin/manage-instruments`)
    ...
    return <ManageInstrumentsClient />
}
