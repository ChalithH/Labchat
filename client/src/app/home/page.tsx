...
export default function Home() {
  return (
    <div className="relative w-full  bg-[#F5F7FA] flex flex-col items-center justify-center">
      ...
      <h2 className="mt-20 play-font font-bold text-4xl">Why choose us?</h2>
...
<div className="relative w-full h-[500px]"> {}
        <img src={ArrowM.src} alt="Magenta Arrow" className="absolute bottom-[35px] right-[65px]" />
        <img src={ArrowB.src} alt="Blue Arrow" className="absolute bottom-[33px] right-[11px]" />
        <img src={star1.src} alt="Star 1" className="absolute bottom-[31px] right-[89px]" />
        <img src={star2.src} alt="Star 2" className="absolute bottom-[33px] right-[39px]" />
      </div>
