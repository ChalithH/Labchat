...
export const FIRST_USER_DATA: UserType = {
    ...
    status: 'In Lab',
    contacts: [
        { id: 1, name: 'My work email', type: 'email', info: 'cole@work.com', primary: true},
        { id: 2, name: 'My personal email', type: 'email', info: 'cole@gmail.com', primary: false },
        { id: 3, name: 'My phone number', type: 'email', info: '+64 0 123 4567', primary: false }
    ]
}
...
export const SECOND_USER_DATA: UserType = {
    ...
    status: 'In Lab',
    contacts: [
        { id: 1, name: 'My work email', type: 'email', info: 'chalith@work.com', primary: true},
        { id: 2, name: 'My work number', type: 'email', info: '+64 0 123 4567', primary: false }
    ]
}

export const FIRST_REPLY_DATA: ReplyType = {
    id: 1,
    author: FIRST_USER_DATA,
